...
function Contract() {
  ...
  const contractTransaction = async (call, method, args) => {
    fetcher.submit({ ...data, call, method, args, contractAbi: data.contractAbiString }, { method: "post", action: "/web3-tx" });
  };
...
//# sourceMappingURL=/build/routes/contract-F7RWGVEM.js.map
